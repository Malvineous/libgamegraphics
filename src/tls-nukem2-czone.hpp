...
#ifndef _CAMOTO_TLS_CZONE_HPP_
#define _CAMOTO_TLS_CZONE_HPP_
...
class TilesetType_Nukem2_CZone: virtual public TilesetType
{
	public:
		TilesetType_Nukem2_CZone();
		virtual ~TilesetType_Nukem2_CZone();
