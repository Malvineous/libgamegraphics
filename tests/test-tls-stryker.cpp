...
class test_tls_stryker_masked: public test_tileset
{
	public:
		...
		{
			return STRING_WITH_NULLS(
				"\xFF\xBF\xBF\xBF\xBF" "\xFF\xFF\xFF\xFF\xFF"
				...
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\xFF\x7F\x00\x80\xFF" "\xFF\xFC\x01\x01\xFD"
			);
		}
		...
		{
			return STRING_WITH_NULLS(
				"\xFF\xFF\xBF\xBF\xBF" "\xFF\xFF\xFF\xFF\xFF"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				...
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\xFF\x7F\x00\x80\xFF" "\xFF\xFE\x01\x01\xFD"
			);
		}
		...
		{
			return STRING_WITH_NULLS(
				"\xFF\xBF\xFF\xBF\xBF" "\xFF\xFF\xFF\xFF\xFF"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				...
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\xFF\x7F\x00\x80\xFF" "\xFF\xFC\x03\x01\xFD"
			);
		}
		...
		{
			return STRING_WITH_NULLS(
				"\xFF\xFF\xFF\xBF\xBF" "\xFF\xFF\xFF\xFF\xFF"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				...
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\x80\x00\x00\x80\x80" "\x01\x00\x01\x00\x01"
				"\xFF\x7F\x00\x80\xFF" "\xFF\xFE\x03\x01\xFD"
			);
		}
