...
class test_tls_harry_ico: public test_tileset
{
	public:
		test_tls_harry_ico()
		{
			this->type = "tls-harry-ico";
			...
			this->content0_largeSize = 4 + 8 * 9;
			this->content0_smallSize = 4 + 5 * 2;
