/**
 * @file   test-img-tv-fog.cpp
 * @brief  Test code for Terminal Velocity FOG images.
 *
...
class test_img_tv_fog: public test_image
{
	public:
		test_img_tv_fog()
		{
			this->type = "img-tv-fog";
			this->hasMask = false;
			this->hasHitmask = false;
			this->fixedDimensions = true;
			this->dimensions = {256, 16};
		}
		...
		void addTests()
		{
			...
			this->sizedContent({256, 16}, ImageType::DefinitelyYes,
				this->initialstate(), {}, this->initialstate());

			// c00: Initial state
			this->isInstance(ImageType::DefinitelyYes, this->initialstate());

			// c01: Image wrong length
			auto c01 = this->initialstate() + "a";
		...
		{
			std::string line = STRING_WITH_NULLS(
